...
class Classify extends StatefulWidget {
  Classify({this.title = 'VideosPlayer Demo'});

  final String title;

  @override
  State<StatefulWidget> createState() {
    return _ClassifyState();
  }
}
...
class _ClassifyState extends State<Classify> {
  ...
  VideosPlayerController _chewieController;

  @override
  void initState() {
    super.initState();
    _videoPlayerController1 = VideoPlayerController.asset(Constant.ASSETS_IMG + "sz.mp4");
    _videoPlayerController2 = VideoPlayerController.network(Constant.ASSETS_IMG + "hqc.mp4");
    _chewieController = VideosPlayerController(
      videoPlayerController: _videoPlayerController1,
      aspectRatio: 3 / 2,
      autoPlay: true,
      looping: true,
